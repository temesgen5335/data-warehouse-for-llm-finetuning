...
BASE_PROMPT = """Generate the news headline given the category:
Human: {}
Assistant [Amharic] : """
...
def main(
    ...
    **kwargs
    ...
    MAIN_PATH = '/home/hillary_kipkemoi/hugging_face_models/garri/Llama-2-7b-hf'
    peft_model = '/home/hillary_kipkemoi/hugging_face_models/garri/llama-2-amharic-3784m/finetuned'
